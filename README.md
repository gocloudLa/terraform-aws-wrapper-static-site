...
| origin_access_control_name            | Name of the Origin Access Control for the CloudFront distribution.                  | `string` | `null`                                                                                                                                  | no       |
| origin_access_control_key_name        | Name of the Origin Access Control signing key for the CloudFront distribution.      | `string` | `null`                                                                                                                                  | no       |
...
| custom_error_response                 | Custom error responses for the CloudFront distribution                              | `map`    | `null`                                                                                                                                  | no       |
